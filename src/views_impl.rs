...
impl View<MapTile> for DebugView {
...
impl View<Entity> for DebugView {
    fn get_description(&self, t: &Entity) -> String {
        todo!()
    }

    fn get_glyph(&self, t: &Entity) -> char {
        todo!()
    }

    fn get_color(&self, t: &Entity) -> RGB {
        todo!()
    }
}

pub struct GameView;
impl View<MapTile> for GameView {
    fn get_description(&self, t: &MapTile) -> String {
        match t {
